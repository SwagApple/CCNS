...
const MapPage = () => {
  ...
  const locations = [
    ...
    { name: 'Phase I Residence Hall', lat: 28.150920, lon: -81.848913, description: 'Residence Hall', categories: ['Housing']  },
    { name: 'Phase II Residence Hall', lat: 28.150111, lon: -81.847578, description: 'Residence Hall', categories: ['Housing'] },
    { name: 'Phase III Residence Hall', lat: 28.149780, lon: -81.848194, description: 'New Residence Hall', categories: ['Housing']  },
    { name: 'The Access Point', lat: 28.149681, lon: -81.847819, description: 'Academic Success Center', categories: ['Student Services'] },
    ...
    { name: 'SDC', lat: 28.148020, lon: -81.845619, description: 'Student Development Center', categories: ['Student Services'] },
